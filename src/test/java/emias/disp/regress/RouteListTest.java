...
public class RouteListTest extends TestBase {
    ...
    @Test(groups = "disp", description = "подписываем мероприятие без маркировок")
    @RetryCountIfFailed(2)
    ...
    // TODO: 4/17/2019 проверить отображение кнопки просмотреть у мероприятия исследование кала на скрытую кровь
}