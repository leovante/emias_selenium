...
public class NavigationTest extends AbstractTestGrid {
    ...
    @Test(groups = "disp", description = "редирект к блоку заключение при редактировании МЛ")
    ...
    @Test(groups = "disp", description = "редирект к блоку заключение при просмотре МЛ из журнала")
    @RetryCountIfFailed(3)
