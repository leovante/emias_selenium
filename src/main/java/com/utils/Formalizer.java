...
public class Formalizer {
    ...
    public Formalizer sendToFormalizer() {
        ...
        try {
            ...
            logger2.info("энтити: " + String.valueOf(entity));
        } catch (Exception ex) {
            ex.printStackTrace();
            logger2.info("Error, " + "Cannot Estabilish Connection");
        }
        return this;
    }
    ...
    public String getEntity() throws IOException, JSONException {
        ...
        if (responseText.has("#text")) {
            logger2.info("#text: " + responseText.getString("#text"));
