...
public class CallDoctorWebPage extends WebPage {
    private PacientImpl pacientImpl;

    public CallDoctorWebPage() throws IOException {
    }

    public CallDoctorWebPage calldoctor(PacientImpl pacientImpl) throws InterruptedException {
    ...
    public CallDoctorWebPage calldoctorSMP(PacientImpl pacientImpl) throws InterruptedException {
        $(By.xpath("//div[@class='fast-buttons']//button[text()='Вызов врача']")).click();
...
//        $(By.name("address")).clear();
    ...
    public CallDoctorWebPage eqCallDoc(String arg1, String arg2, String arg3, String arg4, String arg5, String arg6, String arg7, String arg8, String arg9) throws InterruptedException {
    ...
    public CallDoctorWebPage eqCallDocSMP(String arg1, String arg2, String arg3, String arg4, String arg5) throws InterruptedException {
        SelenideElement lp = $(By.xpath("//*[@id='ccIngoModalCont']/dl/dd[1]"));
        SelenideElement fi = $(By.xpath("//*[@id='ccIngoModalCont']/dl/dd[2]"));
        SelenideElement bir = $(By.xpath("//*[@id='ccIngoModalCont']/dl/dd[3]"));
        SelenideElement adr = $(By.xpath("//*[@id='ccIngoModalCont']/dl/dd[4]"));
