...
public class ModuleCallDoctor {
    ...
    public void createNewCall(){
        ...
        webDriver.findElement(By.xpath("//div[28]/div[3]/div/button/span")).click(); //
        ...
        webDriver.findElement(By.id("Mkb_Name")).click();
        webDriver.findElement(By.xpath("//img[@alt='Выбор']")).click();
        ...
        webDriver.findElement(By.xpath("(//img[@alt='Выбор'])[4]")).click();
        ...
        webDriver.findElement(By.id("CallDoctorType-button")).click();
        webDriver.findElement(By.id("ui-selectmenu-item-884")).click();
        webDriver.findElement(By.xpath("//a[@id='CallDoctorStatus-button']/span")).click();
        webDriver.findElement(By.id("ui-selectmenu-item-160")).click();
        webDriver.findElement(By.id("Comment")).click();
        webDriver.findElement(By.id("btnIsFinalize")).click();
